        ...
        <div class="flex flex-col lg:flex-row lg:justify-between mb-4 gap-3 ">
            <div class="flex flex-col lg:flex-row items-center gap-2">
                <div class="relative w-full lg:w-auto">
                    ...
                    <form method="GET" action="{{ route('expedientes.index') }}" class="flex">
                        <input
                            type="text"
                            name="search"
                            id="table-search"
            ...
            <form action="{{ route('expedientes.index') }}" method="GET" class="flex flex-col lg:flex-row items-center gap-3">
