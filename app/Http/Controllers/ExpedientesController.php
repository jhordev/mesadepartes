        ...
        try {
            ...
            if ($request->tipo_solicitante === 'Natural') {
                ...
                $personaNaturalData = $request->validate([
                    ...
                    'nombre_departamento_natural' => 'nullable|string',
                    'nombre_provincia_natural'   => 'nullable|string',
                    'nombre_distrito_natural'    => 'nullable|string',
                ...
                PersonaNatural::create([
                    ...
                    'Departamento'    => $personaNaturalData['nombre_departamento_natural'] ?? null,
                    'Provincia'       => $personaNaturalData['nombre_provincia_natural'] ?? null,
                    'Distrito'        => $personaNaturalData['nombre_distrito_natural'] ?? null,
