...
@section('content')
    <section class="w-full flex justify-center relative">
        <div class=" shadow-2xl flex flex-col bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
            ...
            <div class="mt-10">
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <div class="flex w-full">
                        <button type="submit"
                                class="flex mt-3 items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
